...
import { CalendarPermissionsSkipLink } from "@/compositions/calendar-permissions/components/calendar-permissions-skip-link"
      ...
      <CalendarPermissionsCard>
        <CalendarPermissionsConnect>
          <CalendarPermissionsHeader>
            <CalendarPermissionsIconPair provider="google" />
            <CalendarPermissionsContent>
              <Heading1>Connect Google</Heading1>
          ...
          <CalendarPermissionsListSection>
            ...
            <CalendarPermissionsActions provider="google" backHref="/login" />
          </CalendarPermissionsListSection>
        </CalendarPermissionsConnect>
      </CalendarPermissionsCard>
