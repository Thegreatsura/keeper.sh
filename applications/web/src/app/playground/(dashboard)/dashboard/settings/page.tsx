  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <Modal open={changePasswordOpen} onClose={() => setChangePasswordOpen(false)}>
        <form onSubmit={(event) => { event.preventDefault(); setChangePasswordOpen(false); }} className="flex flex-col gap-4">
          <ModalHeader
      ...
      <Modal open={deleteAccountOpen} onClose={() => setDeleteAccountOpen(false)}>
        <form onSubmit={(event) => { event.preventDefault(); setDeleteAccountOpen(false); }} className="flex flex-col gap-4">
          <ModalHeader
