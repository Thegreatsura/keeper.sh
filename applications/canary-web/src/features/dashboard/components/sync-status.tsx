...
import { syncStateAtom, syncStatusLabelAtom, syncStatusShimmerAtom, type CompositeSyncState } from "../../../state/sync";
...
function resolveSyncPercent(composite: CompositeSyncState): number | null {
