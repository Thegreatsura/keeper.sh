...
const buttonVariants = tv({
  ...
  compoundVariants: [
    ...
    { variant: "outline", asLink: false, class: "enabled:hover:bg-surface-muted" },
    { variant: "ghost", asLink: false, class: "enabled:hover:bg-surface-muted" },
    { variant: "ghost-hitslop", asLink: false, class: "enabled:hover:bg-surface-muted" },
    { variant: "primary", asLink: true, class: "hover:brightness-90" },
    { variant: "destructive", asLink: true, class: "hover:brightness-90" },
    { variant: "outline", asLink: true, class: "hover:bg-surface-muted" },
    { variant: "ghost", asLink: true, class: "hover:bg-surface-muted" },
    { variant: "ghost-hitslop", asLink: true, class: "hover:bg-surface-muted" },
  ],
  defaultVariants: {
    variant: "primary",
    size: "default",
